    ...
    computed: {
        sortedMembers: function () {
            ...
            if(document.title.includes("Attendance")) {
                 array = this.statistic.Total.LeastEngagedGuys;
            }else if(document.title.includes("Loyalty")) {
                 array = this.statistic.Total.LeastLoyalGuys;
            }
        ...
        sortedMembersSecond: function () {
            let array = [];
            if(document.title.includes("Attendance")) {
                 array = this.statistic.Total.MostEngagedGuys;
            }else if(document.title.includes("Loyalty")) {
                 array = this.statistic.Total.MostLoyalGuys;
            }
            return array.sort((a, b) => {
                let modifier = 1;
                if (this.currentSortDir === 'desc') modifier = -1;
